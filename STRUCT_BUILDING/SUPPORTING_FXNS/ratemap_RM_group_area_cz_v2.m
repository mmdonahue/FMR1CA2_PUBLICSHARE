function [RateMap,RateMap_mat,PeakRate]=ratemap_RM_group_area_cz_v2(path,infile,TTlist,plot_scale,rotate_para,Path_savefig,assemble_note,session_sequence)
% cd('C:\Data\Q\Rat196\Data_Struct_v4_Cohort3.mat');
...
sLength = 100; %Length of arena side (cm)
...
[RateMap,timeMaps,PeakRate,mapAxis,sessions,F,pathCoord,timeStamps] ...
    = equalPlot_RM_step1_rotate_cz_v3(infile,session_period,rotate_para,sLength,bins,h);
